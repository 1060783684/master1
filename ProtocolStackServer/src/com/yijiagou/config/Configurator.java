...
public class Configurator {
    ...
    private static final String JPPATH = "/conf/jedis.properties";
    private static final String SERVERPATH = "/conf/ProtocolStackServer.properties";
    private static final String BSERVERPATH= "/conf/DownLoadServer.properties";
    static {
    ...
    public static void init() throws Exception {
        ...
        try {
            ...
            bserverIn = new BufferedReader(new FileReader(path+BSERVERPATH));
            String conf = "";
